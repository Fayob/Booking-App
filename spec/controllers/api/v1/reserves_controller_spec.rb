...
RSpec.describe Api::V1::ReservesController, type: :controller do
  describe 'when authenticated' do
    before do
      ...
      @reserve = Reserve.create(city: 'Test name', date: '31-12-2023', coach_id: @coach.id, user_id: @user.id)
    ...
    it 'returns a success response after reserving a coach' do
      post :create, params: { city: 'Test name', date: '31-12-2023', coach_id: @coach.id }
      expect(response).to be_successful
    end
